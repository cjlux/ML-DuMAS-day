...
\begin{frame}{Societal issues: {\bf Decision-making, Certification}}
  ...
  \begin{tcolorbox}[title={\bf Evalation, Certification}]
    ...
    \item Example: \href{https://www.lne.fr/fr/service/certification/certification-processus-ia}{LNE Process certification for AI}
    \end{itemize}
  \end{tcolorbox}
  }
...
\begin{frame}{Societal issues: {\bf Trustworthy AI}}
  ...
  \end{minipage}
  \footnotetext{Groupe d'Experts indépendants de Haut Niveau en Intelligence Artificielle (GEHN IA)}
\bigskip      
